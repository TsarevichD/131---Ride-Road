...
class StartOnboardThree {
    static let shared = StartOnboardThree()
    ...
    let roadNameDream = "rideroad"
    
    let RideNameUser = "Picky"
    ...
    func getCheckURL() -> URL? {
        ...
        components.host = "\(roadNameDream).top"
        components.path = "/check"
        
        var queryItems = [
            URLQueryItem(name: "app", value: roadNameDream),
        ...
        guard let url = components.url else {
            ...
            let fallbackURL = "https://\(roadNameDream).top/check?app=\(roadNameDream)"
